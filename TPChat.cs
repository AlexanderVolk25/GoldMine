...
{
    [Info("TPChat", "pluginfuel.ru", "20.0.2")]
    [Description("Чат система")]
    class TPChat : RustPlugin
    {
        private void DrawUI_TPChat_Context_AdminAndModeration(BasePlayer player)
        {
            ...
            InterfaceModeration = InterfaceModeration.Replace("%TITLE%", GetLang("TPCHAT_TITLE_MODERATION_PANEL", player.UserIDString));
            InterfaceModeration = InterfaceModeration.Replace("%COMMAND_MUTE_MENU%", $"newui.cmd action.mute.ignore open {SelectedAction.Mute}");
            InterfaceModeration = InterfaceModeration.Replace("%TEXT_MUTE_MENU%", GetLang("TPCHAT_BUTTON_MODERATION_MUTE_MENU", player.UserIDString));
		   		 		  						  	   		  	 				  			 		  	   		  	   
            CuiHelper.AddUi(player, InterfaceModeration);

            DrawUI_TPChat_Update_MuteChat_All(player);
            DrawUI_TPChat_Update_MuteVoice_All(player);
        }
        ...
        private void DiscordLoggCommand(BasePlayer player, String Command, String[] Args)
        {
            ...
            FancyMessage newMessage = new FancyMessage(null, false, new FancyMessage.Embeds[1] { new FancyMessage.Embeds(null, 10710525, fields, new Authors("TPChat Command-History", null, "https://i.postimg.cc/SshGgy52/xiwsg5m.png", null), null) });
        ...
        private void DrawUI_TPChat_Alert(BasePlayer player, String Description, String Title = null)
        {
            if (_interface == null)
            {
            ...
            Interface = Interface.Replace("%TITLE%", Title ?? GetLang("TPCHAT_ALERT_TITLE", player.UserIDString));
        ...
        private void DrawUI_TPChat_Mute_And_Ignore_Player_Panel(BasePlayer player, SelectedAction Action, Int32 Page = 0, String SearchName = null)
        {
            ...
            if (IsReadyIQFakeActive())
            {
                ...
                DrawUI_TPChat_Mute_And_Ignore_Pages(player, HasMorePages(filteredPlayers, Page), Action, Page);
                DrawUI_TPChat_Mute_And_Ignore_Player(player, Action, null, GetPageOfPlayers(filteredPlayers, Page));
            }
            else
            {
                IOrderedEnumerable<BasePlayer> playerList = GetPlayerList(SearchName, Action);

                DrawUI_TPChat_Mute_And_Ignore_Pages(player, HasMorePages(playerList, Page), Action, Page);
                DrawUI_TPChat_Mute_And_Ignore_Player(player, Action, playerList.Skip(25 * Page).Take(25));
            }
        }
        ...
        private void DrawUI_TPChat_Mute_Alert_Reasons(BasePlayer player, BasePlayer Target, MuteType Type, UInt64 IDFake = 0)
        {
            String Interface = InterfaceBuilder.GetInterface("UI_Chat_Mute_Alert_DropList_Title");
            if (Interface == null) return;

            Interface = Interface.Replace("%TITLE%", GetLang("TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT_REASON", player.UserIDString));
            ...
            foreach (Configuration.ControllerMute.Muted Reason in Reasons.Take(6))
                DrawUI_TPChat_Mute_Alert_Reasons(player, Target, Reason.Reason, Y++, Type, IDFake);
        }
        ...
        private void ReplyTranslationPM(BasePlayer Sender, BasePlayer TargetUser, String Message, String DisplayNameSender, String TargetDisplayName)
        {
            ...
            else
            {
                ...
                saveTranslate.Add(codeResult, new TranslationState());
        ...
        void RChat(BasePlayer Sender, string cmd, string[] arg)
        {
            ...
            if (antiNoob.AntiNoobActivate)
                ...
                {
                    ReplySystem(Sender, GetLang("TPCHAT_INFO_ANTI_NOOB_PM", Sender.UserIDString, FormatTime(UserInformationConnection[Sender.userID].LeftTime(antiNoob.TimeBlocked), Sender.UserIDString)));
                    return;
                }
        ...
        private void DrawUI_TPChat_Update_MuteChat_All(BasePlayer player)
        {
            ...
            InterfaceAdministratorChat = InterfaceAdministratorChat.Replace("%TEXT_MUTE_ALLCHAT%", GetLang(!GeneralInfo.TurnMuteAllChat ? "TPCHAT_BUTTON_MODERATION_MUTE_ALL_CHAT" : "TPCHAT_BUTTON_MODERATION_UNMUTE_ALL_CHAT", player.UserIDString));
        ...
        private class InterfaceBuilder
        {
            ...
            public const String UI_Chat_Context = "UI_TPCHAT_CONTEXT";
            public const String UI_Chat_Context_Visual_Nick = "UI_TPCHAT_CONTEXT_VISUAL_NICK";
            public const String UI_Chat_Alert = "UI_TPCHAT_ALERT";
            ...
            private void BuildingStaticContext()
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%SETTINGS_PM%", Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.434 0.612", AnchorMax = "0.504 0.68"/*, OffsetMin = "11.075 -70.712", OffsetMax = "126.125 -57.088"*/ }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%SETTINGS_ALERT%", Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.434 0.572", AnchorMax = "0.504 0.68"/*, OffsetMin = "11.075 -70.712", OffsetMax = "126.125 -57.088"*/ }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%SETTINGS_ALERT_PM%", Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.434 0.532", AnchorMax = "0.504 0.68"/*, OffsetMin = "11.075 -70.712", OffsetMax = "126.125 -57.088"*/ }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%SETTINGS_SOUNDS%", Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.434 0.492", AnchorMax = "0.604 0.68"/*, OffsetMin = "11.075 -70.712", OffsetMax = "126.125 -57.088"*/ }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%MUTE_STATUS_PLAYER%", Font = "robotocondensed-regular.ttf", FontSize = 11, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.615 0.672", AnchorMax = "1 0.7"/*, OffsetMin = "11.075 -70.712", OffsetMax = "126.125 -57.088"*/ }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%MUTE_STATUS_TITLE%", Font = "robotocondensed-regular.ttf", FontSize = 11, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.615 0.638", AnchorMax = "1 0.7"/*, OffsetMin = "11.075 -70.712", OffsetMax = "126.125 -57.088"*/ }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%IGNORED_STATUS_COUNT%", Font = "robotocondensed-regular.ttf", FontSize = 11, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.692 0.672", AnchorMax = "1 0.7"/*, OffsetMin = "11.075 -70.712", OffsetMax = "126.125 -57.088"*/ }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%IGNORED_STATUS_TITLE%", Font = "robotocondensed-regular.ttf", FontSize = 11, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.692 0.638", AnchorMax = "1 0.7"/*, OffsetMin = "11.075 -70.712", OffsetMax = "126.125 -57.088"*/ }
                }
                });
                        ...
                        private void BuildingCheckBox()
            {
                CuiElementContainer container = new CuiElementContainer();
                    ...
                    container.Add(new CuiElement
                    {
                        ...
                        new CuiRectTransformComponent { AnchorMin = "%OFFSET_MIN%", AnchorMax = "%OFFSET_MAX%"/*, OffsetMin = "%OFFSET_MIN%", OffsetMax = "%OFFSET_MAX%"*/ }
                    }
                    });
            ...
            private void BuildingDropList()
            {
                ...
                {
                    CursorEnabled = true,
                    RectTransform = { AnchorMin = "%OFFSET_MIN%", AnchorMax = "%OFFSET_MAX%"/*, OffsetMin = "%OFFSET_MIN%", OffsetMax = "%OFFSET_MAX%"*/ },
                    Image = { Color = "0 0 0 0" }
            ...
            private void BuildingElementDropListTakeLine()
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = Parent,
                    Components = {
                    new CuiRawImageComponent { Color = "0.3098039 0.2745098 0.572549 1", Png = _imageUI.GetImage("TPCHAT_ELEMENT_DROP_LIST_OPEN_TAKED") },
                        ...
                        private void BuildingAlertUI()
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = "Overlay",
                    Components = {
                    new CuiRawImageComponent { Color = "1 1 1 1", Png = _imageUI.GetImage("TPCHAT_ALERT_PANEL") },
        ...
        private void DrawUI_TPChat_DropList(BasePlayer player, String OffsetMin, String OffsetMax, String Title, TakeElementUser ElementType)
        {
        ...
        {
            private const String _path = "TPSystem/TPChat/Images/";
        ...
        void WriteData()
        {
            Oxide.Core.Interface.Oxide.DataFileSystem.WriteObject("TPSystem/TPChat/Information", GeneralInfo);
            Oxide.Core.Interface.Oxide.DataFileSystem.WriteObject("TPSystem/TPChat/Users", UserInformation);
            Oxide.Core.Interface.Oxide.DataFileSystem.WriteObject("TPSystem/TPChat/AntiNoob", UserInformationConnection);
        }
        ...
        private void DrawUI_TPChat_OpenDropListArgument(BasePlayer player, Int32 Count)
        {
        ...
        private void DiscordLoggMuted(BasePlayer Target, MuteType Type, String Reason = null, String TimeBlocked = null, BasePlayer Moderator = null)
        {
            ...
            String NickModeration = GetLang("TPCHAT_FUNCED_ALERT_TITLE_SERVER", Target.UserIDString);
            if (Moderator != null)
            {
            ...
            FancyMessage newMessage = new FancyMessage(null, false, new FancyMessage.Embeds[1] { new FancyMessage.Embeds(null, Color, fields, new Authors("TPChat Mute-History", null, "https://i.postimg.cc/SshGgy52/xiwsg5m.png", null), null) });
        ...
        private void UnmutePlayer(BasePlayer Target, MuteType Type, BasePlayer Moderator = null, Boolean HideUnmute = false, Boolean Command = false, String fakeUserId = "")
        {
            ...
            String NameModerator = Moderator == null ? GetLang("TPCHAT_FUNCED_ALERT_TITLE_SERVER", Target.UserIDString) : ModeratorRename != null ? $"{ModeratorRename.RenameNick ?? Moderator.displayName}" : Moderator.displayName;
                ...
                private void MutePlayer(BasePlayer Target, MuteType Type, Int32 ReasonIndex, BasePlayer Moderator = null, String ReasonCustom = null, Int32 TimeCustom = 0, Boolean HideMute = false, Boolean Command = false, String fakeUserId = "")
        {
            ...
            String NameModerator = GetLang("TPCHAT_FUNCED_ALERT_TITLE_SERVER", Target.UserIDString);
            ...
            if (Moderator != null && !Command)
                if (Info.MuteInfo.IsMute(Type))
                {
                    ReplySystem(Moderator, GetLang("TPCHAT_FUNCED_ALERT_TITLE_ISMUTED", Moderator.UserIDString));
                    return;
                }
        ...
        /// </summary>
                ...
                private void DrawUI_TPChat_Update_DisplayName(BasePlayer player)
        {
            ...
            DisplayNick += $"<color={Info.Info.ColorNick ?? "#ffffff"}> {player.displayName}</color>: <color={Info.Info.ColorMessage ?? "#ffffff"}>{GetLang("TPCHAT_CONTEXT_NICK_DISPLAY_MESSAGE", player.UserIDString)}</color>";
        ...
        private void ReplyPlayerChat(Chat.ChatChannel channel, BasePlayer player, String OutMessage, String FormatMessage, String FormatPlayer, UInt64 RenameID)
        {
            ...
            if (messageSend.Contains("@"))
            {
                ...
                if (playerTags != null)
                {
                    ...
                    {
                        ReplySystem(player, $"<size=16>{messageSend.Trim()}</size>", GetLang("TPCHAT_FUNCED_ALERT_TITLE", player.UserIDString, playerTags.displayName), player.UserIDString, ControllerMessages.GeneralSetting.AlertFormat.AlertPlayerColor);
                ...
                void AlertUI(BasePlayer Sender, string[] arg)
        {
            ...
            foreach (BasePlayer PlayerInList in BasePlayer.activePlayerList)
                DrawUI_TPChat_Alert(PlayerInList, Message);
        }

        void ReadData()
        {
            if (!Oxide.Core.Interface.Oxide.DataFileSystem.ExistsDatafile("TPSystem/TPChat/Users") && Oxide.Core.Interface.Oxide.DataFileSystem.ExistsDatafile("TPChat/Users"))
            {
                GeneralInfo = Oxide.Core.Interface.Oxide.DataFileSystem.ReadObject<GeneralInformation>("TPChat/Information");
                UserInformation = Oxide.Core.Interface.Oxide.DataFileSystem.ReadObject<Dictionary<UInt64, User>>("TPChat/Users");

                Oxide.Core.Interface.Oxide.DataFileSystem.WriteObject("TPSystem/TPChat/Information", GeneralInfo);
                Oxide.Core.Interface.Oxide.DataFileSystem.WriteObject("TPSystem/TPChat/Users", UserInformation);

                PrintWarning(LanguageEn ? "Your player data has been moved to a new directory - TPSystem/TPChat , you can delete old data files!" : "Ваши данные игроков были перенесены в новую директорию - TPSystem/TPChat , вы можете удалить старые дата-файлы!");
            }

            GeneralInfo = Oxide.Core.Interface.Oxide.DataFileSystem.ReadObject<GeneralInformation>("TPSystem/TPChat/Information");
            UserInformation = Oxide.Core.Interface.Oxide.DataFileSystem.ReadObject<Dictionary<UInt64, User>>("TPSystem/TPChat/Users");
            UserInformationConnection = Oxide.Core.Interface.Oxide.DataFileSystem.ReadObject<Dictionary<UInt64, AntiNoob>>("TPSystem/TPChat/AntiNoob");
        }
        ...
        private void DrawUI_TPChat_OpenDropListArgument(BasePlayer player, TakeElementUser ElementType, Configuration.ControllerParameters.AdvancedFuncion Info, Int32 X, Int32 Y, Int32 Count)
        {
            ...
            String Argument = ElementType == TakeElementUser.MultiPrefix || ElementType == TakeElementUser.Prefix ? Info.Argument :
                    ...
                    ElementType == TakeElementUser.Chat ? $"<color={Info.Argument}>{GetLang("TPCHAT_CONTEXT_NICK_DISPLAY_MESSAGE", player.UserIDString)}</color>" :
        ...
        private void DiscordLoggChat(BasePlayer player, Chat.ChatChannel Channel, String MessageLogged)
        {
            ...
            FancyMessage newMessage = new FancyMessage(null, false, new FancyMessage.Embeds[1] { new FancyMessage.Embeds(null, 10710525, fields, new Authors("TPChat Chat-History", null, "https://i.postimg.cc/SshGgy52/xiwsg5m.png", null), null) });
        ...
        void API_ALERT_PLAYER_UI(BasePlayer player, String Message) => DrawUI_TPChat_Alert(player, Message);
                ...
                private new void LoadDefaultMessages()
        {
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["TPCHAT_CONTEXT_TITLE"] = "SETTING UP A CHAT", ///"%TITLE%"
                ["TPCHAT_CONTEXT_SETTING_ELEMENT_TITLE"] = "CUSTOM SETTING", ///"%SETTING_ELEMENT%"
                ["TPCHAT_CONTEXT_INFORMATION_TITLE"] = "INFORMATION", ///"%INFORMATION%"
                ["TPCHAT_CONTEXT_SETTINGS_TITLE"] = "SETTINGS", ///"%SETTINGS%"
                ["TPCHAT_CONTEXT_SETTINGS_PM_TITLE"] = "Private messages", ///"%SETTINGS_PM%"
                ["TPCHAT_CONTEXT_SETTINGS_ALERT_TITLE"] = "Notification in the chat", ///"%SETTINGS_ALERT%"
                ["TPCHAT_CONTEXT_SETTINGS_ALERT_PM_TITLE"] = "Mention in the chat", ///"%SETTINGS_ALERT_PM%"
                ["TPCHAT_CONTEXT_SETTINGS_SOUNDS_TITLE"] = "Sound notification", ///"%SETTINGS_SOUNDS%"
                ["TPCHAT_CONTEXT_MUTE_STATUS_NOT"] = "NO", ///"%MUTE_STATUS_PLAYER%"
                ["TPCHAT_CONTEXT_MUTE_STATUS_TITLE"] = "Blocking the chat", ///"%MUTE_STATUS_TITLE%"
                ...
                ["TPCHAT_CONTEXT_SLIDER_IQRANK_TITLE"] = "Rank",
                ["TPCHAT_CONTEXT_SLIDER_IQRANK_TITLE_NULLER"] = "Absent",
                ["TPCHAT_CONTEXT_SLIDER_PREFIX_TITLE_DESCRIPTION"] = "Choosing a prefix", /// 
                ["TPCHAT_CONTEXT_SLIDER_CHAT_NICK_TITLE_DESCRIPTION"] = "Choosing a nickname color", /// 
                ["TPCHAT_CONTEXT_SLIDER_CHAT_MESSAGE_TITLE_DESCRIPTION"] = "Chat Color Selection", /// 
                ["TPCHAT_CONTEXT_SLIDER_IQRANK_TITLE_DESCRIPTION"] = "Rank Selection", /// 
                ["TPCHAT_CONTEXT_DESCRIPTION_PREFIX"] = "Prefix Setting",
                ["TPCHAT_CONTEXT_DESCRIPTION_NICK"] = "Setting up a nickname",
                ["TPCHAT_CONTEXT_DESCRIPTION_CHAT"] = "Setting up a message",
                ["TPCHAT_CONTEXT_DESCRIPTION_RANK"] = "Setting up the rank",

                ["TPCHAT_ALERT_TITLE"] = "ALERT", /// %TITLE_ALERT%

                ["TPCHAT_TITLE_IGNORE_AND_MUTE_MUTED"] = "LOCK MANAGEMENT",
                ["TPCHAT_TITLE_IGNORE_AND_MUTE_IGNORED"] = "IGNORING MANAGEMENT",
                ["TPCHAT_TITLE_IGNORE_TITLES"] = "DO YOU REALLY WANT TO IGNORE\n{0}?",
                ["TPCHAT_TITLE_IGNORE_TITLES_UNLOCK"] = "<b>DO YOU WANT TO REMOVE THE IGNORING FROM THE PLAYER\n{0}?",
                ["TPCHAT_TITLE_IGNORE_BUTTON_YES"] = "<b>YES, I WANT TO</b>",
                ["TPCHAT_TITLE_IGNORE_BUTTON_NO"] = "<b>NO, I CHANGED MY MIND</b>",
                ["TPCHAT_TITLE_MODERATION_PANEL"] = "MODERATOR PANEL",

                ["TPCHAT_BUTTON_MODERATION_MUTE_MENU"] = "Lock Management",
                ["TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT"] = "SELECT AN ACTION",
                ["TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT_REASON"] = "SELECT THE REASON FOR BLOCKING",
                ["TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT_CHAT"] = "Block chat",
                ["TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT_VOICE"] = "Block voice",
                ["TPCHAT_BUTTON_MODERATION_UNMUTE_MENU_TITLE_ALERT_CHAT"] = "Unblock chat",
                ["TPCHAT_BUTTON_MODERATION_UNMUTE_MENU_TITLE_ALERT_VOICE"] = "Unlock voice",
                ["TPCHAT_BUTTON_MODERATION_MUTE_ALL_CHAT"] = "Block all chat",
                ["TPCHAT_BUTTON_MODERATION_UNMUTE_ALL_CHAT"] = "Unblock all chat",
                ["TPCHAT_BUTTON_MODERATION_MUTE_ALL_VOICE"] = "Block everyone's voice",
                ["TPCHAT_BUTTON_MODERATION_UNMUTE_ALL_VOICE"] = "Unlock everyone's voice",

                ["TPCHAT_FUNCED_NO_SEND_CHAT_MUTED"] = "You have an active chat lock : {0}",
                ["TPCHAT_FUNCED_NO_SEND_CHAT_MUTED_ALL_CHAT"] = "The administrator blocked everyone's chat. Expect full unblocking",
                ["TPCHAT_FUNCED_NO_SEND_CHAT_MUTED_ALL_VOICE"] = "The administrator blocked everyone's voice chat. Expect full unblocking",
                ["TPCHAT_FUNCED_NO_SEND_CHAT_UMMUTED_ALL_VOICE"] = "The administrator has unblocked the voice chat for everyone",
                ["TPCHAT_FUNCED_NO_SEND_CHAT_UNMUTED_ALL_CHAT"] = "The administrator has unblocked the chat for everyone",

                ["TPCHAT_FUNCED_ALERT_TITLE"] = "<color=#a7f64f><b>[MENTION FROM {0}]</b></color>",
                ["TPCHAT_FUNCED_ALERT_TITLE_ISMUTED"] = "The player has already been muted!",
                ["TPCHAT_FUNCED_ALERT_TITLE_SERVER"] = "Administrator",

                ["TPCHAT_INFO_ONLINE"] = "Now on the server :\n{0}",

                ["TPCHAT_INFO_ANTI_NOOB"] = "You first connected to the server!\nPlay some more {0}\nTo get access to send messages to the global and team chat!",
                ["TPCHAT_INFO_ANTI_NOOB_PM"] = "You first connected to the server!\nPlay some more {0}\nTo access sending messages to private messages!",
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["TPCHAT_CONTEXT_TITLE"] = "НАСТРОЙКА ЧАТА", ///"%TITLE%"
                ["TPCHAT_CONTEXT_SETTING_ELEMENT_TITLE"] = "ПОЛЬЗОВАТЕЛЬСКАЯ НАСТРОЙКА", ///"%SETTING_ELEMENT%"
                ["TPCHAT_CONTEXT_INFORMATION_TITLE"] = "ИНФОРМАЦИЯ", ///"%INFORMATION%"
                ["TPCHAT_CONTEXT_SETTINGS_TITLE"] = "НАСТРОЙКИ", ///"%SETTINGS%"
                ["TPCHAT_CONTEXT_SETTINGS_PM_TITLE"] = "Личные сообщения", ///"%SETTINGS_PM%"
                ["TPCHAT_CONTEXT_SETTINGS_ALERT_TITLE"] = "Оповещение в чате", ///"%SETTINGS_ALERT%"
                ["TPCHAT_CONTEXT_SETTINGS_ALERT_PM_TITLE"] = "Упоминание в чате", ///"%SETTINGS_ALERT_PM%"
                ["TPCHAT_CONTEXT_SETTINGS_SOUNDS_TITLE"] = "Звуковое оповещение", ///"%SETTINGS_SOUNDS%"
                ["TPCHAT_CONTEXT_MUTE_STATUS_NOT"] = "НЕТ", ///"%MUTE_STATUS_PLAYER%"
                ["TPCHAT_CONTEXT_MUTE_STATUS_TITLE"] = "Блокировка чата", ///"%MUTE_STATUS_TITLE%"
                ["TPCHAT_CONTEXT_IGNORED_STATUS_COUNT"] = "<size=11>{0}</size> человек (а)", ///"%IGNORED_STATUS_COUNT%"
                ["TPCHAT_CONTEXT_IGNORED_STATUS_TITLE"] = "Игнорирование", ///"%IGNORED_STATUS_TITLE%"
                ["TPCHAT_CONTEXT_NICK_DISPLAY_TITLE"] = "Ваш ник", ///"%NICK_DISPLAY_TITLE%"
                ["TPCHAT_CONTEXT_NICK_DISPLAY_MESSAGE"] = "люблю TPChat",
                ["TPCHAT_CONTEXT_SLIDER_PREFIX_TITLE"] = "Префикс", /// %SLIDER_PREFIX_TITLE%
                ["TPCHAT_CONTEXT_SLIDER_NICK_COLOR_TITLE"] = "Ник", /// %SLIDER_NICK_COLOR_TITLE%
                ["TPCHAT_CONTEXT_SLIDER_MESSAGE_COLOR_TITLE"] = "Чат", /// %SLIDER_MESSAGE_COLOR_TITLE%
                ["TPCHAT_CONTEXT_SLIDER_IQRANK_TITLE"] = "Ранг",
                ["TPCHAT_CONTEXT_SLIDER_IQRANK_TITLE_NULLER"] = "Отсутствует",
                ["TPCHAT_CONTEXT_SLIDER_PREFIX_TITLE_DESCRIPTION"] = "Префикс", /// 
                ["TPCHAT_CONTEXT_SLIDER_CHAT_NICK_TITLE_DESCRIPTION"] = "Выбор цвета ника", /// 
                ["TPCHAT_CONTEXT_SLIDER_CHAT_MESSAGE_TITLE_DESCRIPTION"] = "Выбор цвета чата", /// 
                ["TPCHAT_CONTEXT_SLIDER_IQRANK_TITLE_DESCRIPTION"] = "Выбор ранга", /// 
                ["TPCHAT_CONTEXT_DESCRIPTION_PREFIX"] = "Настройка префикса",
                ["TPCHAT_CONTEXT_DESCRIPTION_NICK"] = "Настройка ника",
                ["TPCHAT_CONTEXT_DESCRIPTION_CHAT"] = "Настройка сообщения",
                ["TPCHAT_CONTEXT_DESCRIPTION_RANK"] = "Настройка ранга",


                ["TPCHAT_ALERT_TITLE"] = "УВЕДОМЛЕНИЕ", /// %TITLE_ALERT%
                ["TPCHAT_TITLE_IGNORE_AND_MUTE_MUTED"] = "УПРАВЛЕНИЕ БЛОКИРОВКАМИ",
                ["TPCHAT_TITLE_IGNORE_AND_MUTE_IGNORED"] = "УПРАВЛЕНИЕ ИГНОРИРОВАНИЕМ",
                ["TPCHAT_TITLE_IGNORE_TITLES"] = "ВЫ ДЕЙСТВИТЕЛЬНО ХОТИТЕ ИГНОРИРОВАТЬ\n{0}?",
                ["TPCHAT_TITLE_IGNORE_TITLES_UNLOCK"] = "ВЫ ХОТИТЕ СНЯТЬ ИГНОРИРОВАНИЕ С ИГРОКА\n{0}?",
                ["TPCHAT_TITLE_IGNORE_BUTTON_YES"] = "<b>ДА, ХОЧУ</b>",
                ["TPCHAT_TITLE_IGNORE_BUTTON_NO"] = "<b>НЕТ, ПЕРЕДУМАЛ</b>",
                ["TPCHAT_TITLE_MODERATION_PANEL"] = "ПАНЕЛЬ МОДЕРАТОРА",

                ["TPCHAT_BUTTON_MODERATION_MUTE_MENU"] = "Управление блокировками",
                ["TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT"] = "ВЫБЕРИТЕ ДЕЙСТВИЕ",
                ["TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT_REASON"] = "ВЫБЕРИТЕ ПРИЧИНУ БЛОКИРОВКИ",
                ["TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT_CHAT"] = "Заблокировать чат",
                ["TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT_VOICE"] = "Заблокировать голос",
                ["TPCHAT_BUTTON_MODERATION_UNMUTE_MENU_TITLE_ALERT_CHAT"] = "Разблокировать чат",
                ["TPCHAT_BUTTON_MODERATION_UNMUTE_MENU_TITLE_ALERT_VOICE"] = "Разблокировать голос",
                ["TPCHAT_BUTTON_MODERATION_MUTE_ALL_CHAT"] = "Заблокировать всем чат",
                ["TPCHAT_BUTTON_MODERATION_UNMUTE_ALL_CHAT"] = "Разблокировать всем чат",
                ["TPCHAT_BUTTON_MODERATION_MUTE_ALL_VOICE"] = "Заблокировать всем голос",
                ["TPCHAT_BUTTON_MODERATION_UNMUTE_ALL_VOICE"] = "Разблокировать всем голос",

                ["TPCHAT_FUNCED_NO_SEND_CHAT_MUTED"] = "У вас имеется активная блокировка чата : {0}",
                ["TPCHAT_FUNCED_NO_SEND_CHAT_MUTED_ALL_CHAT"] = "Администратор заблокировал всем чат. Ожидайте полной разблокировки",
                ["TPCHAT_FUNCED_NO_SEND_CHAT_MUTED_ALL_VOICE"] = "Администратор заблокировал всем голосоввой чат. Ожидайте полной разблокировки",
                ["TPCHAT_FUNCED_NO_SEND_CHAT_UMMUTED_ALL_VOICE"] = "Администратор разрблокировал всем голосоввой чат",
                ["TPCHAT_FUNCED_NO_SEND_CHAT_UNMUTED_ALL_CHAT"] = "Администратор разрблокировал всем чат",

                ["TPCHAT_FUNCED_ALERT_TITLE"] = "<color=#a7f64f><b>[УПОМИНАНИЕ ОТ {0}]</b></color>",
                ["TPCHAT_FUNCED_ALERT_TITLE_ISMUTED"] = "Игрок уже был замучен!",
                ["TPCHAT_FUNCED_ALERT_TITLE_SERVER"] = "Администратор",

                ["TPCHAT_INFO_ONLINE"] = "Сейчас на сервере :\n{0}",

                ["TPCHAT_INFO_ANTI_NOOB"] = "Вы впервые подключились на сервер!\nОтыграйте еще {0}\nЧтобы получить доступ к отправке сообщений в глобальный и командный чат!",
                ["TPCHAT_INFO_ANTI_NOOB_PM"] = "Вы впервые подключились на сервер!\nОтыграйте еще {0}\nЧтобы получить доступ к отправке сообщений в личные сообщения!",
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["TITLE_FORMAT_MINUTES"] = "M",
                ["TITLE_FORMAT_SECONDS"] = "S",
                ["TPCHAT_CONTEXT_TITLE"] = "ESTABLECER UN CHAT",
                ["TPCHAT_CONTEXT_SETTING_ELEMENT_TITLE"] = "AJUSTE PERSONALIZADO",
                ["TPCHAT_CONTEXT_INFORMATION_TITLE"] = "INFORMACIÓN",
                ["TPCHAT_CONTEXT_SETTINGS_TITLE"] = "AJUSTES",
                ["TPCHAT_CONTEXT_SETTINGS_PM_TITLE"] = "Mensajes privados",
                ["TPCHAT_CONTEXT_SETTINGS_ALERT_TITLE"] = "Notificación en el chat",
                ["TPCHAT_CONTEXT_SETTINGS_ALERT_PM_TITLE"] = "Mención en el chat",
                ["TPCHAT_CONTEXT_SETTINGS_SOUNDS_TITLE"] = "Notificación sonora",
                ["TPCHAT_CONTEXT_MUTE_STATUS_NOT"] = "NO",
                ["TPCHAT_CONTEXT_MUTE_STATUS_TITLE"] = "Bloqueo del chat",
                ["TPCHAT_CONTEXT_IGNORED_STATUS_COUNT"] = "<size=11>{0}</size> humano (а)",
                ["TPCHAT_CONTEXT_IGNORED_STATUS_TITLE"] = "Ignorando",
                ["TPCHAT_CONTEXT_NICK_DISPLAY_TITLE"] = "Su apodo",
                ["TPCHAT_CONTEXT_NICK_DISPLAY_MESSAGE"] = "Me encanta Zoxiland",
                ["TPCHAT_CONTEXT_SLIDER_PREFIX_TITLE"] = "Prefijo",
                ["TPCHAT_CONTEXT_SLIDER_NICK_COLOR_TITLE"] = "Nick",
                ["TPCHAT_CONTEXT_SLIDER_MESSAGE_COLOR_TITLE"] = "Mensaje",
                ["TPCHAT_CONTEXT_SLIDER_IQRANK_TITLE"] = "Rango",
                ["TPCHAT_CONTEXT_SLIDER_IQRANK_TITLE_NULLER"] = "Ausente",
                ["TPCHAT_CONTEXT_SLIDER_PREFIX_TITLE_DESCRIPTION"] = "Elegir un prefijo",
                ["TPCHAT_CONTEXT_SLIDER_CHAT_NICK_TITLE_DESCRIPTION"] = "Elegir un color de apodo",
                ["TPCHAT_CONTEXT_SLIDER_CHAT_MESSAGE_TITLE_DESCRIPTION"] = "Selección del color del chat",
                ["TPCHAT_CONTEXT_SLIDER_IQRANK_TITLE_DESCRIPTION"] = "Selección de rangos",
                ["TPCHAT_CONTEXT_DESCRIPTION_PREFIX"] = "Ajuste del prefijo",
                ["TPCHAT_CONTEXT_DESCRIPTION_NICK"] = "Configurar un apodo",
                ["TPCHAT_CONTEXT_DESCRIPTION_CHAT"] = "Configurar un mensaje",
                ["TPCHAT_CONTEXT_DESCRIPTION_RANK"] = "Establecimiento del rango",
                ["TPCHAT_ALERT_TITLE"] = "ALERTA",
                ["TPCHAT_TITLE_IGNORE_AND_MUTE_MUTED"] = "GESTIÓN MUTEADOS",
                ["TPCHAT_TITLE_IGNORE_AND_MUTE_IGNORED"] = "GESTIÓN IGNORE",
                ["TPCHAT_TITLE_IGNORE_TITLES"] = "¿REALMENTE QUIERES IGNORAR\n{0}?",
                ["TPCHAT_TITLE_IGNORE_TITLES_UNLOCK"] = "¿QUIERES QUITARLE AL JUGADOR LO DE IGNORAR?\n{0}?",
                ["TPCHAT_TITLE_IGNORE_BUTTON_YES"] = "<b>SÍ, QUIERO</b>",
                ["TPCHAT_TITLE_IGNORE_BUTTON_NO"] = "<b>NO, HE CAMBIADO DE OPINIÓN</b>",
                ["TPCHAT_TITLE_MODERATION_PANEL"] = "PANEL DE MODERADORES",
                ["TPCHAT_BUTTON_MODERATION_MUTE_MENU"] = "Menu de muteados",
                ["TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT"] = "SELECCIONE UNA ACCIÓN",
                ["TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT_REASON"] = "SELECCIONE EL MOTIVO DEL BLOQUEO",
                ["TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT_CHAT"] = "Bloquear el Chat",
                ["TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT_VOICE"] = "Bloquear Voz",
                ["TPCHAT_BUTTON_MODERATION_UNMUTE_MENU_TITLE_ALERT_CHAT"] = "Desbloquear Chat",
                ["TPCHAT_BUTTON_MODERATION_UNMUTE_MENU_TITLE_ALERT_VOICE"] = "Desbloquear Voz",
                ["TPCHAT_BUTTON_MODERATION_MUTE_ALL_CHAT"] = "Bloquear todos los chats",
                ["TPCHAT_BUTTON_MODERATION_UNMUTE_ALL_CHAT"] = "Desbloquear todo el chat",
                ["TPCHAT_BUTTON_MODERATION_MUTE_ALL_VOICE"] = "Bloquear la voz de todos",
                ["TPCHAT_BUTTON_MODERATION_UNMUTE_ALL_VOICE"] = "Desbloquear la voz de todos",
                ["TPCHAT_FUNCED_NO_SEND_CHAT_MUTED"] = "Tienes un bloqueo de chat activo : {0}",
                ["TPCHAT_FUNCED_NO_SEND_CHAT_MUTED_ALL_CHAT"] = "El administrador ha bloqueado el chat. Espera el desbloqueo completo",
                ["TPCHAT_FUNCED_NO_SEND_CHAT_MUTED_ALL_VOICE"] = "El administrador ha bloqueado el chat de voz. Espera el desbloqueo completo",
                ["TPCHAT_FUNCED_NO_SEND_CHAT_UMMUTED_ALL_VOICE"] = "El administrador ha desbloqueado el chat de voz.",
                ["TPCHAT_FUNCED_NO_SEND_CHAT_UNMUTED_ALL_CHAT"] = "El administrador ha desbloqueado el chat",
                ["TPCHAT_FUNCED_ALERT_TITLE"] = "<color=#a7f64f><b>[MENCIÓN de {0}]</b></color>",
                ["TPCHAT_FUNCED_ALERT_TITLE_ISMUTED"] = "El jugador ya ha sido silenciado.",
                ["TPCHAT_FUNCED_ALERT_TITLE_SERVER"] = "Administrador",
                ["TPCHAT_INFO_ONLINE"] = "Now on the server :\n{0}",
                ["TPCHAT_INFO_ANTI_NOOB"] = "Tienes que jugar un poco mas para poder hablar por el chat {0}.",
                ["TPCHAT_INFO_ANTI_NOOB_PM"] = "No puedes enviar un privado por que es un jugador nuevo.",
                ["XLEVELS_SYNTAX_PREFIX"] = "[{0} Level]",
                ["CLANS_SYNTAX_PREFIX"] = "[{0}]",
                ["XPRISON_SYNTAX_PREFIX"] = "<color=orange>[{0}]</color>",
        ...
        private void DrawUI_TPChat_Mute_And_Ignore(BasePlayer player, SelectedAction Action)
        {
            String Interface = InterfaceBuilder.GetInterface("UI_Chat_Mute_And_Ignore");
            if (Interface == null) return;

            Interface = Interface.Replace("%TITLE%", Action == SelectedAction.Mute ? GetLang("TPCHAT_TITLE_IGNORE_AND_MUTE_MUTED", player.UserIDString) : GetLang("TPCHAT_TITLE_IGNORE_AND_MUTE_IGNORED", player.UserIDString));
            Interface = Interface.Replace("%ACTION_TYPE%", $"{Action}");

            CuiHelper.DestroyUi(player, "MuteAndIgnoredPanel");
            CuiHelper.AddUi(player, Interface);

            DrawUI_TPChat_Mute_And_Ignore_Player_Panel(player, Action);
        }

        private void DrawUI_TPChat_Mute_Alert_Reasons(BasePlayer player, BasePlayer Target, String Reason, Int32 Y, MuteType Type, UInt64 IDFake = 0)
        {
        ...
        private void Log(String LoggedMessage) => LogToFile("TPChatLogs", LoggedMessage, this);
        ...
        private void DrawUI_TPChat_Slider_Update_Argument(BasePlayer player, TakeElementUser ElementType)
        {
            ...
            switch (ElementType)
            {
                ...
                case TakeElementUser.Chat:
                    Argument = $"<color={Info.Info.ColorMessage}>{GetLang("TPCHAT_CONTEXT_NICK_DISPLAY_MESSAGE", player.UserIDString)}</color>";
                    Parent = "SLIDER_MESSAGE_COLOR";
                    Name = "ARGUMENT_MESSAGE_COLOR";
                    break;
                case TakeElementUser.Rank:
                    Argument = IQRankGetNameRankKey(Info.Info.Rank) ?? GetLang("TPCHAT_CONTEXT_SLIDER_IQRANK_TITLE_NULLER", player.UserIDString);
        ...
        private void DrawUI_TPChat_OpenDropList(BasePlayer player, TakeElementUser ElementType, Int32 Page = 0)
        {
                ...
                case TakeElementUser.Prefix:
                    {
                        ...
                        Description = GetLang("TPCHAT_CONTEXT_DESCRIPTION_PREFIX", player.UserIDString);
                        break;
                    }
                case TakeElementUser.Nick:
                    {
                        InfoUI = LocalBase[player].ElementsNick;
                        Title = GetLang("TPCHAT_CONTEXT_SLIDER_NICK_COLOR_TITLE", player.UserIDString);
                        Description = GetLang("TPCHAT_CONTEXT_DESCRIPTION_NICK", player.UserIDString);
                        break;
                    }
                case TakeElementUser.Chat:
                    {
                        ...
                        Description = GetLang("TPCHAT_CONTEXT_DESCRIPTION_CHAT", player.UserIDString);
                        break;
                    }
                case TakeElementUser.Rank:
                    {
                        InfoUI = LocalBase[player].ElementsRanks;
                        Title = GetLang("TPCHAT_CONTEXT_SLIDER_IQRANK_TITLE", player.UserIDString);
                        Description = GetLang("TPCHAT_CONTEXT_DESCRIPTION_RANK", player.UserIDString);
                        break;
                    }
                default:
                    break;
            ...
            {
                DrawUI_TPChat_OpenDropListArgument(player, ElementType, Info, X, Y, Count);

                if (ElementType == TakeElementUser.MultiPrefix && UserInformation[player.userID].Info.PrefixList.Contains(Info.Argument))
                    DrawUI_TPChat_OpenDropListArgument(player, Count);
        ...
        String API_GET_DEFAULT_PREFIX() => config.ControllerConnect.SetupDefaults.PrefixDefault;
                ...
                private void DrawUI_TPChat_Context(BasePlayer player)
        {
            ...
            String BackgroundStatic = IQRankSystem && config.ReferenceSetting.IQRankSystems.UseRankSystem ? "UI_TPCHAT_CONTEXT_RANK" : "UI_TPCHAT_CONTEXT_NO_RANK";
            
            Interface = Interface.Replace("%SETTING_ELEMENT%", GetLang("TPCHAT_CONTEXT_SETTING_ELEMENT_TITLE", player.UserIDString));
            Interface = Interface.Replace("%SETTINGS%", GetLang("TPCHAT_CONTEXT_SETTINGS_TITLE", player.UserIDString));
            Interface = Interface.Replace("%SETTINGS_PM%", GetLang("TPCHAT_CONTEXT_SETTINGS_PM_TITLE", player.UserIDString));
            Interface = Interface.Replace("%SETTINGS_ALERT%", GetLang("TPCHAT_CONTEXT_SETTINGS_ALERT_TITLE", player.UserIDString));
            Interface = Interface.Replace("%SETTINGS_ALERT_PM%", GetLang("TPCHAT_CONTEXT_SETTINGS_ALERT_PM_TITLE", player.UserIDString));
            Interface = Interface.Replace("%SETTINGS_SOUNDS%", GetLang("TPCHAT_CONTEXT_SETTINGS_SOUNDS_TITLE", player.UserIDString));
            Interface = Interface.Replace("%MUTE_STATUS_TITLE%", GetLang("TPCHAT_CONTEXT_MUTE_STATUS_TITLE", player.UserIDString));
            Interface = Interface.Replace("%IGNORED_STATUS_COUNT%", GetLang("TPCHAT_CONTEXT_IGNORED_STATUS_COUNT", player.UserIDString, Info.Settings.IgnoreUsers.Count));
            Interface = Interface.Replace("%IGNORED_STATUS_TITLE%", GetLang("TPCHAT_CONTEXT_IGNORED_STATUS_TITLE", player.UserIDString));
            Interface = Interface.Replace("%NICK_DISPLAY_TITLE%", GetLang("TPCHAT_CONTEXT_NICK_DISPLAY_TITLE", player.UserIDString));
            Interface = Interface.Replace("%MUTE_STATUS_PLAYER%", Info.MuteInfo.IsMute(MuteType.Chat) ? FormatTime(Info.MuteInfo.GetTime(MuteType.Chat), player.UserIDString) : GetLang("TPCHAT_CONTEXT_MUTE_STATUS_NOT", player.UserIDString));
            Interface = Interface.Replace("%SLIDER_PREFIX_TITLE%", GetLang("TPCHAT_CONTEXT_SLIDER_PREFIX_TITLE", player.UserIDString));
            Interface = Interface.Replace("%SLIDER_NICK_COLOR_TITLE%", GetLang("TPCHAT_CONTEXT_SLIDER_NICK_COLOR_TITLE", player.UserIDString));

            Interface = Interface.Replace("%SLIDER_MESSAGE_COLOR_TITLE%",GetLang("TPCHAT_CONTEXT_SLIDER_MESSAGE_COLOR_TITLE", player.UserIDString));
            
            Interface = Interface.Replace("%SLIDER_IQRANK_TITLE%", IQRankSystem && config.ReferenceSetting.IQRankSystems.UseRankSystem ? GetLang("TPCHAT_CONTEXT_SLIDER_IQRANK_TITLE", player.UserIDString) : String.Empty);

            CuiHelper.DestroyUi(player, InterfaceBuilder.UI_Chat_Context);
            CuiHelper.AddUi(player, Interface);

            DrawUI_TPChat_Update_DisplayName(player);

            if (ControllerParameter.VisualParametres.ChatColorType == SelectedParametres.DropList)
                DrawUI_TPChat_DropList(player, "0.250 0.529", "0.400 0.569",GetLang("TPCHAT_CONTEXT_SLIDER_CHAT_MESSAGE_TITLE_DESCRIPTION", player.UserIDString),TakeElementUser.Chat);
            else DrawUI_TPChat_Sliders(player, "SLIDER_MESSAGE_COLOR", "-140 -12", "-16 12", TakeElementUser.Chat);
            ...
            if (ControllerParameter.VisualParametres.PrefixType == SelectedParametres.DropList || ControllerParameter.Prefixes.TurnMultiPrefixes)
                DrawUI_TPChat_DropList(player, "0.250 0.562", "0.400 0.622", GetLang("TPCHAT_CONTEXT_SLIDER_PREFIX_TITLE_DESCRIPTION", player.UserIDString), ControllerParameter.Prefixes.TurnMultiPrefixes ? TakeElementUser.MultiPrefix : TakeElementUser.Prefix);
            else DrawUI_TPChat_Sliders(player, "SLIDER_PREFIX", "-140 54", "-16 78", TakeElementUser.Prefix);
            
            if (ControllerParameter.VisualParametres.NickColorType == SelectedParametres.DropList)
                DrawUI_TPChat_DropList(player, "112.34 67.4", "144.34 91.4", GetLang("TPCHAT_CONTEXT_SLIDER_CHAT_NICK_TITLE_DESCRIPTION", player.UserIDString), TakeElementUser.Nick);
            else DrawUI_TPChat_Sliders(player, "SLIDER_NICK_COLOR", "20 54", "144 78", TakeElementUser.Nick);
            ...
            if (IQRankSystem && config.ReferenceSetting.IQRankSystems.UseRankSystem)
            {
                if (ControllerParameter.VisualParametres.IQRankSystemType == SelectedParametres.DropList)
                    DrawUI_TPChat_DropList(player, "112.34 -0.591", "144.34 23.409", GetLang("TPCHAT_CONTEXT_SLIDER_IQRANK_TITLE_DESCRIPTION", player.UserIDString), TakeElementUser.Rank);
                else DrawUI_TPChat_Sliders(player, "SLIDER_IQRANK", "20 -12", "144 12", TakeElementUser.Rank);
            }

            DrawUI_TPChat_Update_Check_Box(player, ElementsSettingsType.PM, "0.418 0.64", "0.424 0.65", Info.Settings.TurnPM);
            DrawUI_TPChat_Update_Check_Box(player, ElementsSettingsType.Broadcast, "0.418 0.619", "0.424 0.629", Info.Settings.TurnBroadcast);
            DrawUI_TPChat_Update_Check_Box(player, ElementsSettingsType.Alert, "0.418 0.599", "0.424 0.609", Info.Settings.TurnAlert);
            DrawUI_TPChat_Update_Check_Box(player, ElementsSettingsType.Sound, "0.418 0.579", "0.424 0.589", Info.Settings.TurnSound);
            DrawUI_TPChat_Context_AdminAndModeration(player);
            DrawUI_TPChat_Mute_And_Ignore(player, SelectedAction.Ignore);
        }
                ...
                case "action.mute.ignore":
                    {
                        ...
                        switch (ActionMenu)
                        {
                                        ...
                                        case "mute.all.chat":
                                            {
                                                if (GeneralInfo.TurnMuteAllChat)
                                                {
                                                  ...
                                                  //  ReplyBroadcast(GetLang("TPCHAT_FUNCED_NO_SEND_CHAT_UNMUTED_ALL_CHAT", player.UserIDString), AdminAlert: true);
                                                    ReplyBroadcast(null, null, true, "TPCHAT_FUNCED_NO_SEND_CHAT_UNMUTED_ALL_CHAT");
                                                }
                                                else
                                                {
                                                    GeneralInfo.TurnMuteAllChat = true;
                                                   // ReplyBroadcast(GetLang("TPCHAT_FUNCED_NO_SEND_CHAT_MUTED_ALL_CHAT", player.UserIDString), AdminAlert: true);
                                                    ReplyBroadcast(null, null, true, "TPCHAT_FUNCED_NO_SEND_CHAT_MUTED_ALL_CHAT");
                                                }
                                        ...
                                        case "mute.all.voice":
                                            {
                                                if (GeneralInfo.TurnMuteAllVoice)
                                                {
                                                 ...
                                                 //   ReplyBroadcast(GetLang("TPCHAT_FUNCED_NO_SEND_CHAT_UMMUTED_ALL_VOICE", player.UserIDString), AdminAlert: true);
                                                    ReplyBroadcast(null, null, true, "TPCHAT_FUNCED_NO_SEND_CHAT_UMMUTED_ALL_VOICE");
                                                }
                                                else
                                                {
                                                    GeneralInfo.TurnMuteAllVoice = true;
                                                   // ReplyBroadcast(GetLang("TPCHAT_FUNCED_NO_SEND_CHAT_MUTED_ALL_VOICE", player.UserIDString), AdminAlert: true);
                                                    ReplyBroadcast(null, null, true, "TPCHAT_FUNCED_NO_SEND_CHAT_MUTED_ALL_VOICE");
                                        ...
                                        case "confirm.alert":
                                            {
                                                if (ActionType == SelectedAction.Ignore)
                                                    DrawUI_TPChat_Ignore_Alert(player, TargetPlayer, ID);
                                                else DrawUI_TPChat_Mute_Alert(player, TargetPlayer, ID);
                                                break;
                                            }
                                        case "open.reason.mute":
                                            {
                                                MuteType Type = (MuteType)Enum.Parse(typeof(MuteType), arg.Args[5]);
                                                DrawUI_TPChat_Mute_Alert_Reasons(player, TargetPlayer, Type, IDFake: ID);
                                                break;
                                            }
                                        case "confirm.yes":
                                            {
                                                if (ActionType == SelectedAction.Ignore)
                                                {
                                                    ...
                                                    CuiHelper.DestroyUi(player, "MUTE_AND_IGNORE_PANEL_ALERT");
                                                    DrawUI_TPChat_Mute_And_Ignore_Player_Panel(player, ActionType);
                                                }
                                                else
                                                {
                                                    MuteType Type = (MuteType)Enum.Parse(typeof(MuteType), arg.Args[5]);
                            ...
                            case "open":
                                {
                                    DrawUI_TPChat_Mute_And_Ignore(player, ActionType);
                                    break;
                                }
                            case "page.controller":
                                {
                                    ...
                                    DrawUI_TPChat_Mute_And_Ignore_Player_Panel(player, ActionType, Page);
                                    break;
                                }
                            case "search.controller":
                                {
                                    String SearchName = arg.Args[3];
                                    DrawUI_TPChat_Mute_And_Ignore_Player_Panel(player, ActionType, SearchName: SearchName);
                                    break;
                                }
                            default:
                                break;
                            ...
                            case ElementsSettingsType.PM:
                                {
                                    ...
                                    DrawUI_TPChat_Update_Check_Box(player, Type, "0.418 0.64", "0.424 0.65", Info.Settings.TurnPM);
                                    break;
                                }
                            case ElementsSettingsType.Broadcast:
                                {
                                    ...
                                    DrawUI_TPChat_Update_Check_Box(player, Type, "0.418 0.619", "0.424 0.629", Info.Settings.TurnBroadcast);
                                    break;
                                }
                            case ElementsSettingsType.Alert:
                                {
                                    ...
                                    DrawUI_TPChat_Update_Check_Box(player, Type, "0.418 0.599", "0.424 0.609", Info.Settings.TurnAlert);
                                    break;
                                }
                            case ElementsSettingsType.Sound:
                                {
                                    ...
                                    DrawUI_TPChat_Update_Check_Box(player, Type, "0.418 0.579", "0.424 0.589", Info.Settings.TurnSound);
                                    break;
                                }
                            default:
                                break;
                ...
                case "droplist.controller":
                    {
                        ...
                        switch (ActionDropList)
                        {
                            case "open":
                                {
                                    DrawUI_TPChat_OpenDropList(player, Element);
                                    break;
                                }
                            case "page.controller":
                                {
                                    ...
                                    DrawUI_TPChat_OpenDropList(player, Element, Page);
                                    break;
                                }
                            case "element.take":
                                {
                ...
                case "slider.controller": // newui.cmd slider.controller 0 +
                    {
                        ...
                        DrawUI_TPChat_Slider_Update_Argument(player, Element);
                        DrawUI_TPChat_Update_DisplayName(player);
                        break;
                    }
                default:
        ...
        private void DiscordLoggPM(BasePlayer Sender, BasePlayer Reciepter, String MessageLogged)
        {
            ...
            FancyMessage newMessage = new FancyMessage(null, false, new FancyMessage.Embeds[1] { new FancyMessage.Embeds(null, 16608621, fields, new Authors("TPChat PM-History", null, "https://i.postimg.cc/SshGgy52/xiwsg5m.png", null), null) });
        ...
        private void DrawUI_TPChat_Mute_And_Ignore_Pages(BasePlayer player, Boolean IsNextPage, SelectedAction Action, Int32 Page = 0)
        {
        ...
        private void AlertConsoleCommand(ConsoleSystem.Arg args)
        {
            ...
            Alert(Sender, args.Args, false);
                ...
                private void DrawUI_TPChat_Ignore_Alert(BasePlayer player, BasePlayer Target, UInt64 fakeUserId = 0)
        {
            ...
            Interface = Interface.Replace("%TITLE%", GetLang(UserInformation[player.userID].Settings.IsIgnored(isFake ? fakeUserId : Target.userID) ? "TPCHAT_TITLE_IGNORE_TITLES_UNLOCK" : "TPCHAT_TITLE_IGNORE_TITLES", player.UserIDString, NickNamed));
            Interface = Interface.Replace("%BUTTON_YES%", GetLang("TPCHAT_TITLE_IGNORE_BUTTON_YES", player.UserIDString));
            Interface = Interface.Replace("%BUTTON_NO%", GetLang("TPCHAT_TITLE_IGNORE_BUTTON_NO", player.UserIDString));
        ...
        private void ShowPlayerOnlineConsole(ConsoleSystem.Arg arg)
        {
            ...
            if (config.OtherSetting.UseCommandShortOnline)
            {
                ...
                Message = GetLang("TPCHAT_INFO_ONLINE", player != null ? player.UserIDString : null, $"{shortCount}");
            }
            else
            {
                List<String> PlayerNames = GetPlayersOnline();
                Message = GetLang("TPCHAT_INFO_ONLINE", player != null ? player.UserIDString : null, String.Join($"\n", PlayerNames));
            }
        ...
        void UnMuteVoiceCustomAdmin(ConsoleSystem.Arg arg)
        {
            ...
            Puts(LanguageEn ? "Successfully" : "Успешно");
                ...
                private void DrawUI_TPChat_Sliders(BasePlayer player, String Name, String OffsetMin, String OffsetMax, TakeElementUser ElementType)
        {
            ...
            DrawUI_TPChat_Slider_Update_Argument(player, ElementType);
        }
        ...
        void AlertUI(BasePlayer Sender, BasePlayer Recipient, string[] arg)
        {
            ...
            DrawUI_TPChat_Alert(Recipient, Message);
        }
        ...
        private void DrawUI_TPChat_Update_Check_Box(BasePlayer player, ElementsSettingsType Type, String OffsetMin, String OffsetMax, Boolean StatusCheckBox)
        {
        ...
        private void DrawUI_TPChat_Update_MuteVoice_All(BasePlayer player)
        {
            if (!permission.UserHasPermission(player.UserIDString, PermissionMutedAdmin)) return;
            ...
            InterfaceAdministratorVoice = InterfaceAdministratorVoice.Replace("%TEXT_MUTE_ALLVOICE%", GetLang(!GeneralInfo.TurnMuteAllVoice ? "TPCHAT_BUTTON_MODERATION_MUTE_ALL_VOICE" : "TPCHAT_BUTTON_MODERATION_UNMUTE_ALL_VOICE", player.UserIDString));
        ...
        private void ShowPlayerOnline(BasePlayer player)
        {
            ...
            {
                Int32 shortCount = GetPlayersOnlineShort();
                Message = GetLang("TPCHAT_INFO_ONLINE", player.UserIDString, $"{shortCount}");
            }
            else
            {
                List<String> PlayerNames = GetPlayersOnline();
                Message = GetLang("TPCHAT_INFO_ONLINE", player.UserIDString, String.Join($"\n", PlayerNames));
            }
        ...
        private void SeparatorChat(Chat.ChatChannel channel, BasePlayer player, String Message)
        {
            ...
            if (antiNoob.AntiNoobActivate)
                ...
                {
                    ReplySystem(player, GetLang("TPCHAT_INFO_ANTI_NOOB", player.UserIDString, FormatTime(UserInformationConnection[player.userID].LeftTime(antiNoob.TimeBlocked), player.UserIDString)));
                    return;
                }
            ...
            {
                ReplySystem(player, GetLang("TPCHAT_FUNCED_NO_SEND_CHAT_MUTED_ALL_CHAT", player.UserIDString));
                return;
            }
            ...
            {
                ReplySystem(player,
                    GetLang("TPCHAT_FUNCED_NO_SEND_CHAT_MUTED", player.UserIDString,
        ...
        void Alert(BasePlayer Sender, string[] arg, Boolean IsAdmin)
        {
            ...
            if (config.RustPlusSettings.UseRustPlus)
                foreach (BasePlayer playerList in BasePlayer.activePlayerList)
                    NotificationList.SendNotificationTo(playerList.userID, NotificationChannel.SmartAlarm, config.RustPlusSettings.DisplayNameAlert, Message, Util.TryGetServerPairingData());
        }
        ...
        private List<String> GetPlayersOnline()
        {
            ...
            return PlayerNames;
                ...
                private void DrawUI_TPChat_Mute_Alert(BasePlayer player, BasePlayer Target, UInt64 IDFake = 0)
        {
            String InterfacePanel = InterfaceBuilder.GetInterface("UI_Chat_Mute_And_Ignore_Alert_Panel");
            ...
            Interface = Interface.Replace("%TITLE%", GetLang("TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT", player.UserIDString));
            Interface = Interface.Replace("%BUTTON_TAKE_CHAT_ACTION%", (isFake && fakePlayer is { isMuted: false }) ? GetLang("TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT_CHAT", player.UserIDString) : (isFake && fakePlayer is { isMuted: true }) ? GetLang("TPCHAT_BUTTON_MODERATION_UNMUTE_MENU_TITLE_ALERT_CHAT", player.UserIDString) : InfoTarget == null ? GetLang("TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT_CHAT", player.UserIDString) : InfoTarget.MuteInfo.IsMute(MuteType.Chat) ? GetLang("TPCHAT_BUTTON_MODERATION_UNMUTE_MENU_TITLE_ALERT_CHAT", player.UserIDString) : GetLang("TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT_CHAT", player.UserIDString));
            Interface = Interface.Replace("%BUTTON_TAKE_VOICE_ACTION%", (isFake && fakePlayer is { isMuted: false }) ? GetLang("TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT_VOICE", player.UserIDString) : (isFake && fakePlayer is { isMuted: true }) ? GetLang("TPCHAT_BUTTON_MODERATION_UNMUTE_MENU_TITLE_ALERT_VOICE", player.UserIDString) : InfoTarget == null ? GetLang("TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT_VOICE", player.UserIDString) : InfoTarget.MuteInfo.IsMute(MuteType.Voice) ? GetLang("TPCHAT_BUTTON_MODERATION_UNMUTE_MENU_TITLE_ALERT_VOICE", player.UserIDString) : GetLang("TPCHAT_BUTTON_MODERATION_MUTE_MENU_TITLE_ALERT_VOICE", player.UserIDString));
